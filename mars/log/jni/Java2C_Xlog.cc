...
JNIEXPORT jlong JNICALL Java_com_sirius_mars_xlog_Xlog_newXlogInstance
...
JNIEXPORT jlong JNICALL Java_com_sirius_mars_xlog_Xlog_getXlogInstance
...
JNIEXPORT void JNICALL Java_com_sirius_mars_xlog_Xlog_releaseXlogInstance
    (JNIEnv *env, jobject, jstring _nameprefix) {
    ScopedJstring nameprefix_jstr(env, _nameprefix);
    mars::xlog::ReleaseXloggerInstance(nameprefix_jstr.GetChar());
}

JNIEXPORT void JNICALL Java_com_sirius_mars_xlog_Xlog_appenderOpen
...
JNIEXPORT void JNICALL Java_com_sirius_mars_xlog_Xlog_appenderFlush(JNIEnv *env, jobject, jlong _log_instance_ptr, jboolean _is_sync) {
    CHECK_LOG_INSTANCE(_log_instance_ptr);
    mars::xlog::Flush(_log_instance_ptr, _is_sync);
}

JNIEXPORT void JNICALL Java_com_sirius_mars_xlog_Xlog_logWrite
...
JNIEXPORT void JNICALL Java_com_sirius_mars_xlog_Xlog_logWrite2
...
JNIEXPORT jint JNICALL Java_com_sirius_mars_xlog_Xlog_getLogLevel
...
JNIEXPORT void JNICALL Java_com_sirius_mars_xlog_Xlog_setLogLevel
  (JNIEnv *, jobject, jlong _log_instance_ptr, jint _log_level) {
    CHECK_LOG_INSTANCE(_log_instance_ptr);
    mars::xlog::SetLevel(_log_instance_ptr, (TLogLevel)_log_level);
}

JNIEXPORT void JNICALL Java_com_sirius_mars_xlog_Xlog_setAppenderMode
